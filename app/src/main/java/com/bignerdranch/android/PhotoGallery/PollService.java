...
public class PollService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String query = prefs.getString(FlickrFetchr.PRE_SEARCH_QUERY, null);
        String lastResultId = prefs.getString(FlickrFetchr.PRE_LAST_RESULT_ID, null);
...
//            sendBroadcast(new Intent(ACTION_SHOW_NOTIFICATION), PERM_PRIVATE);
        ...
        prefs.edit().putString(FlickrFetchr.PRE_LAST_RESULT_ID, resultId).commit();
    }

    public  static void setServiceAlaram(Context context, boolean isOn){
